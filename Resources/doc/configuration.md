...
ambta_doctrine_encrypt:
    ...
    encryptor_class:      \Ambta\DoctrineEncryptBundle\Encryptors\HaliteEncryptor # your own encryption class
```
...
<ambta_doctrine_encrypt:config>
        ...
        <ambta_doctrine_encrypt:encryptor_class>\Ambta\DoctrineEncryptBundle\Encryptors\HaliteEncryptor</ambta_doctrine_encrypt:encryptor_class>
</ambta_doctrine_encrypt:config>
```
